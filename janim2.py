...
def makeanim(files=[],ctlOnSide=False,revOrder=False,sortOrder=False,
             titlestring="animation",fileOfFileNames="",outfile="",what=""):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-w","--what", dest="what",type=str,
                     help="what you are looking at",default="")
    ...
    if len(args.files) == 0:
        ...
        webpage = makeanim(args.files,ctlOnSide=args.ctlOnSide,revOrder=args.revOrder,sortOrder=args.sortOrder,
             titlestring=args.titlestring, fileOfFileNames=args.fileOfFileNames,outfile=args.outfile,what=args.what)
        if not args.outfile:
            print(webpage)
